...
`elmx`                 | Elmx (Elm Syntax Extension)                      |
...
`jade`                 | Jade Template                                    | [Demo](https://photon.sh/demo?language=jade){target="_blank"}
...
`swig`                 | Swig Template                                    |
`systemd`              | systemd                                          | [Demo](https://photon.sh/demo?language=systemd){target="_blank"}
